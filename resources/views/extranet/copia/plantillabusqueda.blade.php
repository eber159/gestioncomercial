...
<link rel="stylesheet" href="{{ asset('assets_int/plugins/jqGrid/css/ui.jqgrid.css')}}">
<link rel="stylesheet" href="{{ asset('assets_int/plugins/jqGrid/themes/smoothness/jquery-ui.theme.css')}}">
...
<link rel="stylesheet" type="text/css" href="{{ asset('adminstyleextranet/styles/contact-responsive.css') }}">
	...
	<style type="text/css">
	    ...
	    .ui-state-highlight, .ui-widget-content .ui-state-highlight, .ui-widget-header .ui-state-highlight {
		    ...
		    background: #2a1a69 url(images/ui-bg_flat_55_fbec88_40x100.png) 50% 50% repeat-x;
		    color: #f8f9fa;
		}
		...
		<div class="header_bar d-flex flex-row align-items-center justify-content-start">
			<div class="header_list">
				<ul class="d-flex flex-row align-items-center justify-content-start">
					...
					<li class="d-flex flex-row align-items-center justify-content-start">
						<img src="{{ asset('img/logo2.png') }}" alt="" height="54px">
					</li>
					<li class="d-flex flex-row align-items-center justify-content-start">
						<a style="color: white">VRD PER&Uacute; BÚSQUEDA DE PIEDRAS</a>
					</li>
				</ul>
			</div>
			<div class="ml-auto d-flex flex-row align-items-center justify-content-start">
				<div class="social">
					<ul class="d-flex flex-row align-items-center justify-content-start">
						<li class="submenu"><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
						<li class="submenu"><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
						<li class="submenu"><a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
					</ul>
				</div>
				<div class="log_reg d-flex flex-row align-items-center justify-content-start">
					<ul class="d-flex flex-row align-items-start justify-content-start">
						...
						@endif
						-->
						<li class="submenu"><a href="#" data-toggle="dropdown"><i class="fa fa-user-o"></i></a>
							<span class="caret"></span></button>
							  <ul class="dropdown-menu">
							  	<li class="linksubmenu"><a href="mispedidos">Mis Pedidos</a></li>
							  	<li class="linksubmenu">
							  		<div style="background-color: #040c50; color: #040c50; padding: 3px">
							  			<a href="#"><i class="fa fa-user"></i>  &nbsp; {{ Session::get('nombreusuario') }}</a>
							  		</div>
							  	</li>
							  	<li class="linksubmenu"><a href="#" onclick="Logout()" class="btn btn-default btn-flat">Cerrar Sesión</a></li>
							  </ul>
						</li>
					</ul>
				</div>
	...
	<div class="menu text-right">
		...
		<div class="menu_log_reg">
			<div class="log_reg d-flex flex-row align-items-center justify-content-end">
				<ul class="d-flex flex-row align-items-start justify-content-start">
					<li><a href="login">Login</a></li>
					<li><a href="registro">Registro3</a></li>
				</ul>
			</div>
			<nav class="menu_nav">
				<ul>
...
<script src="{{ asset('assets_int/bower_components/jquery/dist/jquery-3.3.1.min.js')}}"></script>
...
<script src="{{ asset('adminstyleextranet/plugins/jqGrid/js/i18n/grid.locale-en.js')}}" ></script>
<script src="{{ asset('adminstyleextranet/plugins/jqGrid/js/jquery.jqgrid.min.js')}}" ></script>
...
<script type="text/javascript">
	...
	function Logout() {
        bootbox.confirm("¿Seguro que deseas Cerrar Sesión?", function (result) {
            if (result) {
                var info = "";
                $.ajax({
                    type: "POST",
