...
@section('titulo-form')
	Registro de Pedidos <small>Panel de Control</small>
@stop
...
@section('contenido')
						...
						<div class="box-body">
							<div class="row">
											...
											<div class="input-group input-group-sm">
												<select class="form-control select2" style="width: 100%;" id='idcliente' name="idcliente" >
													...
													@foreach ($clientes as $c)
														<option value="{{ $c->id }}">{{ $c->numerodocumento }} - {{ $c->nombre }}</option>
													@endforeach
												</select>	
												<span class="input-group-btn">
							                    	<button type="button" id="btnAgregarEmpresa" class="btn btn-success btn-flat">NUEVO</button>
							                    </span>
											</div>
								...
								<div class="col-md-12">
									<div class="col-md-12">
										<div class="form-group">
											<button class="btn btn-success" id="btnAgregarProducto" name="btnAgregarProducto" placeholder="" style="width: 100%; text-align: right;">AGREGAR PRODUCTO</button>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-md-12">
									...
									<div class="col-md-12">
										<div class="form-group">
											<button type="button" style="width: 100%; text-align: center;font-size:16px" id="btnGuardar" name="btnGuardar" class="btn btn-primary btn-sm" style="display:none"><i class="fa fa-save"></i> Guardar</button>
										</div>
									</div>
								</div>
							</div>
        ...
        <div class="modal-dialog" >
            <div class="modal-content">
                ...
                <div class="modal-footer">
					<button class="btn btn-success" id="btnAgregar" name="btnAgregar" placeholder="" style="width: 100%; text-align: right;">AGREGAR</button>
                </div>
            </div>
        </div>
        <!-- /.modal-content -->
                	...
                	<div class='row'>
                    	<div class="col-md-12">
							<div class="col-md-6">
                                ...
                                <input type="hidden" class="form-control" id="idcliente2" name="idcliente2"
                                    placeholder="Numero" style="width: 100%">
                            </div>
                            <div class="col-md-6">
                                <label for="">Fecha</label>
    ...
    <div class="modal modal-default fade" id="modalempresa">
        <div class="modal-dialog">
            <div class="modal-content">
            	<form id="frmEmpresa" action="" method="post">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	                	...
	                	<div class='row'>
	                    	<div class="col-md-12">
	                    		 <div class="col-md-6">
	                                <label for="">Tipo Documento</label>
	                                <select class="form-control" style="width: 100%;"
	                                        id='cmbtipodocumentoidentidad' name="cmbtipodocumentoidentidad" required="required" onchange="ActivarControles()">
	                            ...
	                            <div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="nrodocumentoidentidad" name="nrodocumentoidentidad" placeholder="N° Documento" style="width: 100%" required="required">
									</div>
								</div>

								<div class="col-md-12" id="divrazonsocial">
									<div class="form-group">
										<label for="">Razón Social</label>
										<input type="text" class="form-control" id="razonsocial" name="razonsocial" placeholder="Apellido Paterno" style="width: 100%" >
									</div>
								</div>


	                    		<div class="col-md-6" id="divapellidopaterno">
									<div class="form-group">
								...
								<div class="col-md-6" id="divapellidomaterno">
									<div class="form-group">
								...
								<div class="col-md-12" id="divnombres"> 
									<div class="form-group">
										<label for="">Nombres</label>
										<input type="text" class="form-control" id="nombres" name="nombres" placeholder="Nombres" style="width: 100%">
									</div>
								</div>	
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="number" class="form-control" id="telefono1" name="telefono1" placeholder="Teléfono" style="width: 100%">
									</div>
								</div>	
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="email" class="form-control" id="correo" name="correo" placeholder="Correo" style="width: 100%">
									</div>
								</div>	
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="direccion1" name="direccion1" placeholder="Dirección 1" style="width: 100%">
									</div>
								</div>
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="direccion2" name="direccion2" placeholder="Dirección 2" style="width: 100%">
									</div>
								</div>
                ...
                <div class="modal-footer">
                	<button type="submit" id="btnGuardarCliente" name="btnGuardarCliente" class="btn btn-success btn-sm"><i
                                        class="fa fa-save"></i>Guardar</button>
                </div>
                </form>
            </div>
	...
	<script type="text/javascript">
		$(function () {
			...
			function InicializarTablaDetallesSalidas () {
				var Table = $('#tblDetallesOS').dataTable({
				    ...
				    'aoColumns': [{
				      ...
				      "sWidth": "10%", "mDataProp": "IdAlmacen"
				    },{
				      "sWidth": "10%", "mDataProp": "IdLote"
				    }, {
				      'sWidth': '5%', 'mDataProp': 'Cantidad'
				    }, {
				      'sWidth': '5%', 'mDataProp': 'Precio'
				    },{
				      'sWidth': '8%', 'mDataProp': 'Total'
				    }]
				})
			}
			...
			*/
			...
			$(document).on('change', '#idalmacensalida', function (e) {
				if($("#idalmacensalida").val()!=""){
					var oTable2 = $("#tblDetallesOS").DataTable();
					oTable2.rows().eq(0).each( function ( index ) {
						var row = oTable2.row( index );
					    var data = row.data();
					    var Linea = data["Row"];
						$("#cmbAlmacenSalida"+Linea).val($("#idalmacensalida").val());

						var $combo2 = $('#cmbLote'+Linea)
						$combo2.empty()
						$combo2.append("<option value='0'>SIN LOTE</option>");
						$.post("{{ URL::to('intranet/logistica/inventario/Listar') }}" , {"idalmacen":$("#idalmacensalida").val(),"idproducto":data["IdMaterial"] },
							function (data) {
							$.each(data.lista, function (index, item) {
								if(item.stock>0){
									$combo2.append("<option value='" + item.idlote + "'>"
									+ item.nrolote + "-" + " FV.: " + item.fechavencimiento + " S:" + item.stock + '</option>')
								}
							})
						}, 'json')
			...
			$("#btnAgregarEmpresa").on("click", function(event) {
				ActivarControles();
			...
			*/
			...
			$('#nrodocumento').focusout(function() {			
				$('#nrodocumento').val(formatoDocumento($('#nrodocumento').val(),8));
			})
			...
			$("#btnImprimir").on("click", function(event) {
				if( $("#id").val()!='' ){
					window.open("impresionpedido/"+"{{ Session::get('nombreusuario') }}"+"/"+$("#id").val()+"/pdf/mini");
				}else{
		...
		function ActivarControles(){
	  		if( $("#cmbtipodocumentoidentidad").val()=="3" ){
	  			/*
	  			$("#").style.display = "none";
	  			$("#").style.display = "none";
	  			$("#").style.display = "none";
				...
				*/
	  			...
	  			document.getElementById("divapellidopaterno").style.display = "none";
	  			document.getElementById("divapellidomaterno").style.display = "none";
	  			document.getElementById("divrazonsocial").style.display = "block";

	  		}else{
	  			/*
	  			$("#divnombres").style.display = "block";
	  			$("#divapellidopaterno").style.display = "block";
	  			$("#divapellidomaterno").style.display = "block";
	  			$("#divrazonsocial").style.display = "none";
	  			*/
	  			document.getElementById("divnombres").style.display = "block";
	  			document.getElementById("divapellidopaterno").style.display = "block";
	  			document.getElementById("divapellidomaterno").style.display = "block";
	                ...
	                oTable.DataTable( {
	                    ...
	                    "columns": [
	                                ...
	                                { "data": null, "width": "8%",
	                                	"render": function (data, type, row) {
	                                		...
	                                		if(row.idestado == {{config('constants.estadopedido.generado')}}){
												boton_aprobar = "<a class='btn btn-success btn-xs' href='javascript:;' onclick='AprobarPedido("+row.id+")' class='blue' title='Aprobar Pedido'>"
																		+"<i class='fa fa-check'></i>"
																	+"</a>";
												boton_rechazar = "<a class='btn btn-warning btn-xs' href='javascript:;' onclick='RechazarPedido("+row.id+","+row.idcliente+")' class='blue' title='Rechazar Pedido'>"
																		+"R"
																	+"</a>";

											}else{
												if(row.idestado == {{config('constants.estadopedido.atendido')}}){
													boton_despachar = "<a class='btn btn-primary btn-xs' href='javascript:;' onclick='TransitoPedido("+row.id+")' class='blue' title='Pedido en Despacho o Tránsito'>"
																			+"ED"
																		+"</a>";

												}else{
													if(row.idestado == {{config('constants.estadopedido.transito')}}  || row.idestado == {{config('constants.estadopedido.atendidoparcial')}}   ){
														boton_aprobar = "";
														boton_rechazar = "";
														boton_transito = "<a class='btn btn-default btn-xs' href='javascript:;' onclick='DespacharPedido("+row.id+","+row.idcliente+")' class='blue' title='Despachar Pedido'>"
																			+"D"
																		+"</a>";
														boton_despachar = "";
														boton_liquidar = "";
														...
														if(row.idestado == {{config('constants.estadopedido.despachado')}}){
															...
															boton_rechazar = "";
															boton_despachar = "";
															boton_liquidar = "<a class='btn btn-info btn-xs' href='javascript:;' onclick='LiquidarPedido("+row.id+","+row.idcliente+")' class='blue' title='Liquidar Pedido'>L</a>";
															boton_transito = "";
														}else{
											...
											return boton_aprobar+boton_despachar+boton_rechazar+boton_liquidar+boton_transito
	                            	...
	                            	{ "data": null, "width": "10%",
	                                	"render": function (data, type, row) {
											...
											if(row.idtipopago == {{config('constants.tipopago.contado')}}){
												...
												if(row.idestado == {{config('constants.estadopedido.atendidoparcial')}}){
													return "<span class='label label-success'>ATEND. PARCIAL</span>"
												}
											}else{
												if(row.idestado == {{config('constants.estadopedido.atendido')}}){
												...
												if(row.idestado == {{config('constants.estadopedido.atendidoparcial')}}){
													return "<span class='label label-warning'>ATEND. PARCIAL</span>"
												}
											}
	                                ...
	                                { "data": null,
	                                        ...
	                                        "orderable":true,
	                                        "render": function (data, type, row) {
	                                        	return "<a class='btn btn-default btn-xs' href='impresionpedido/"+"{{ Session::get('nombreusuario') }}"+"/"+row.id+"/pdf/mini' target='_blank' title='Imprimir'>"
															+"<i class='ace-icon fa fa-print bigger-130'></i>"
														+"</a>"
                                        				+"<a class='btn btn-primary btn-xs' href='javascript:;' onclick='EditarVenta(\"ordenpedido/Leer\","+row.id+")' class='blue' title='Editar Pedido'>"
		...
		function DespacharPedido(id,idcliente){
			/*
			CargarComboAlmacenSalidas();
			CargarPedidos(id,1);
			$('#fechasalida').datepicker({
			...
			$("#modaldocumentoventa").modal("show");
			*/
			var estadopedido = "{{ config('constants.estadopedido.despachado') }}";
			bootbox.confirm("¿Seguro que deseas DESPACHAR?", function(result) {
				if(result){
					$.ajax({
						type: "POST",
						async: false,
						...
						success: function (data) {
							if(data.success == true){
								//bootbox.alert("PEDIDO LIQUIDADO");
								Listar();
							}else{
								bootbox.alert(data.message);
								console.log(data.message);
			...
			bootbox.confirm("¿Seguro que deseas Rechazar el pedido?", function(result) {
				if(result){
					$.ajax({
						...
						success: function (data) {
							if(data.success == true){
								//bootbox.alert("PEDIDO RECHAZADO");
								Listar();
							}else{
								bootbox.alert(data.message);
								console.log(data.message);
		...
		function LiquidarPedido(id,idcliente){
			var estadopedido = "{{ config('constants.estadopedido.liquidado') }}";
			bootbox.confirm("¿Seguro que deseas Liquidar el pedido?", function(result) {
				if(result){
					$.ajax({
						type: "POST",
						async: false,
		...
		function TransitoPedido(id,idcliente){
			var estadopedido = "{{ config('constants.estadopedido.transito') }}";
			bootbox.confirm("¿Seguro que deseas colocar el pedido EN DESPACHO?", function(result) {
				if(result){
					$.ajax({
						type: "POST",
						async: false,
		...
		function CargarTipoDocumento() {
			...
			function (data) {
				$.each(data.lista, function (index, item) {
					if(item.nombre=="DOCUMENTO INTERNO" || item.nombre=="BOLETA" || item.nombre=="FACTURA"){
		...
		function CargarPedidos(id,indoperacion) {
			//0: aprobar -  1: despacho
			var info = "";
			$.ajax({
				type: "POST",
				async: false,
						...
						$.each(data.obj, function (key, val) {
					        ...
					        $.each(data.detalles, function (key, val2) {
								...
								if(indoperacion==0){
									...
									"IdUM": val2["idunidadmedida"],
									"IdAlmacen": "<select id='cmbAlmacenSalida" + Linea + "'></select>",
									"IdLote": "<select id='cmbLote" + Linea + "'></select>",
									...
									if(val2["pend_sal"]>0){
										...
										"IdAlmacen": "<select id='cmbAlmacenSalida" + Linea + "'></select>",
										"IdLote": "<select id='cmbLote" + Linea + "'></select>",
										'Cantidad': "<input type='number' class='form-control2' value= '" + parseFloat(val2['pend_sal']).toFixed(2) + "' id='txtCantidadSalida" + Linea + "' name='txtCantidadSalida" + Linea + "' style='text-align: right; width: 100px' >",
										'Precio': "<input type='number' class='form-control2' value= '" + parseFloat(val2['precio']).toFixed(2) + "' id='txtPrecioSalida" + Linea + "' name='txtPrecioSalida" + Linea + "' style='text-align: right; width: 100px' >",
										'Total': "<input type='number' class='form-control2' value= '" + parseFloat(val2['valor_vta']).toFixed(2) + "' id='txtTotalSalida" + Linea + "' name='txtTotalSalida" + Linea + "' style='text-align: right; width: 100px' >"
										}	
										oTableDetalles.fnAddData(objdet);
				...
				complete: function(){
					...
					oTableDetalles.rows().eq(0).each( function ( index ) {
						...
						var $combo = $('#cmbAlmacenSalida'+Linea)
						$combo.empty()
						$.post('../logistica/almacen/Listar',
							function (data) {
							$.each(data.lista, function (index, item) {
						...
						$combo2.empty()
						$combo2.append("<option value='0'>SIN LOTE</option>");
						$.post("{{ URL::to('intranet/logistica/inventario/Listar') }}" , {"idalmacen":"1","idproducto":data["IdMaterial"] },
							function (data) {
							var idloteprin = 0;
							var contador = 0;
							$.each(data.lista, function (index, item) {
								if(item.stock>0){
									...
									+ item.nrolote + "-" + " FV.: " + item.fechavencimiento + " S:" + item.stock + '</option>');
									if(contador==0){
										idloteprin = item.idlote;
									}
									contador = contador + 1;
								}
							})
							if(contador > 0){
								$('#cmbLote'+Linea).val(idloteprin)
							}
						}, 'json')


						$(document).on('change', '#cmbAlmacenSalida'+Linea, function (e) {
							if($('#cmbAlmacenSalida'+Linea).val()!=""){
								var $combo2 = $('#cmbLote'+Linea)
								$combo2.empty()
								$combo2.append("<option value='0'>SIN LOTE</option>");
								$.post("{{ URL::to('intranet/logistica/inventario/Listar') }}" , {"idalmacen":$('#cmbAlmacenSalida'+Linea).val(),"idproducto":data["IdMaterial"] },
									function (data) {
									var idloteprin = 0;
									var contador = 0;
									$.each(data.lista, function (index, item) {
		...
		function ObtenerObjetoDocumento(){
			...
			var obj = {
				...
				,"idclienteproveedor": $("#idcliente2").val()
				,"idperiodo": 1
		...
		function ObtenerObjetoOrdenSalida(){
			...
			oTable2.rows().eq(0).each(function (index) {
				...
				var precio = Number ($("#txtPrecioSalida"+fila).val() );
				var valor_vta_igv = Number ( $("#txtTotalSalida"+fila).val() );
				var idalmacen = Number ($("#cmbAlmacenSalida"+fila).val() );
				var idlote = Number ($("#cmbLote"+fila).val() );
		...
		function validarRegistroEmpresa(){
			if( $("#cmbtipodocumentoidentidad").val()=="3" ){
				if( $("#razonsocial").val()=="" ){
					alert("No se ha especificado una razon social");
	            	return false;
				}
	        }else{
	        	if( $("#nombres").val()=="" ){
					alert("No se ha especificado un nombre para el cliente");
	            	return false;
				}
	        }
		...
		$("#frmEmpresa").submit(function(e) {
			...
			if(validarRegistroEmpresa()){
				var obj = {
					"tipodocumento": $("#cmbtipodocumentoidentidad").val()
					,"nrodocumento": $("#nrodocumentoidentidad").val()
					...
					,"indcliente": 1
					,"indproveedor": 0
					,"idtipocuenta": "{{ config('constants.tipocuenta.cliente') }}"
				};
				...
				$.ajax({
					...
					async: false,
					data: obj,
					url: "../configuracion/empresa/GuardadoRapido",
					dataType: "json",
					beforeSend: function (data) {
							...
							if(data.success == true){
					            ...
					            $.post('../configuracion/empresa/Listar',
					                    function (data) {
					                        ...
					                        $("#idcliente").val(idempresa).trigger('change');
					                    }, 'json');

					            //buscarCuenta(data.idempresa);
