	                    ...
	                    "columns": [
	                                ...
	                                { "data": null, "width": "8%",
	                                	"render": function (data, type, row) {
											...
											return "<a class='btn btn-default btn-xs' href='impresionpedido/"+"{{ Session::get('nombreusuario') }}"+"/"+row.id+"/pdf/mini' class='blue' title='Imprimir Pedido' target='_blank'>"
																+"<i class='ace-icon fa fa-print bigger-130'></i>"
															+"</a>" + boton_aprobar+boton_despachar+boton_rechazar+boton_transito
	                                ...
	                                { "data": null,
	                                        ...
	                                        "orderable":true,
	                                        "render": function (data, type, row) {
	                                        	return "<a class='btn btn-danger btn-xs' href='javascript:;' onclick='Eliminar(\"ordenpedido/Eliminar\","+row.id+")' class='red' title='Eliminar Pedido'>"
																+"<i class='ace-icon fa fa-times bigger-130'></i>"
															+"</a>"
														+"</div>"
	                                    	},"width": "25%"
			...
			//bootbox.confirm("¿Seguro que deseas Rechazar el pedido?", function(result) {
				//if(result){
					$.ajax({
						type: "POST",
						async: false,
						data: {"id":id,"idestado": estadopedido},
						url: "../comercial/ordenpedido/CambiarEstado",
						dataType: "json",
						beforeSend: function (data) {
