@section('title-page')
	ErpWeb | Reporte Clientes
@stop

@extends('plantilla_rpt')

@section('titulo-form')
	Reporte Clientes <small>Panel de Control</small>
@stop

@section('subtitulo-form')
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-dashboard"></i> Reporte de Clientes </a></li>
					...
					if (data !== null && typeof data === 'object') {
						$.each(data.lista, function (key, val) {
							var obj = {
									...
									,"Nombre": val["nombre"]
									,"TipoEmpresa": val["tipoempresa"]
									,"Direccion1": val["direccion1"]
