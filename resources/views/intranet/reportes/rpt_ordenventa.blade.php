@section('title-page')
	ErpWeb | Reporte Ventas
@stop

@extends('intranet.plantilla_rpt')

@section('titulo-form')
	Reporte Ventas <small>Panel de Control</small>
@stop
			...
			function InicializarTabla() {
				...
				var Table = $('#tblDatos').dataTable({
					...
					"aoColumns": [{
							...
							"sWidth": "5%", "mDataProp": "Pedido"
						},{
							"sWidth": "10%", "mDataProp": "Vendedor"
						},{
