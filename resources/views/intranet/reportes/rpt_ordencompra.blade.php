@section('title-page')
	ErpWeb | Reporte Compras
@stop

@extends('plantilla_rpt')

@section('titulo-form')
	Reporte Compras <small>Panel de Control</small>
@stop

@section('subtitulo-form')
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-dashboard"></i> Reporte de Compras </a></li>
			...
			function InicializarTabla() {
				...
				var Table = $('#tblDatos').dataTable({
					...
					"aoColumns": [{
							...
							"sWidth": "7%", "mDataProp": "Fecha"
						}, {
							"sWidth": "7%", "mDataProp": "FechaEntrega"
						}, {
							"sWidth": "7%", "mDataProp": "FechaPago"
						}, {
							"sWidth": "15%", "mDataProp": "Cliente"
						}, {
							"sWidth": "10%", "mDataProp": "Cuenta"
						},{
							"sWidth": "5%", "mDataProp": "Documentos"
						},{
							"sWidth": "5%", "mDataProp": "SubTotal"
						},{
							"sWidth": "5%", "mDataProp": "Igv"
						},{
							"sWidth": "5%", "mDataProp": "Total"
						},{
					...
					if (data !== null && typeof data === 'object') {
						$.each(data.lista, function (key, val) {
							var obj = {
									...
									,"FechaEntrega": val["fecharecepcion"]
