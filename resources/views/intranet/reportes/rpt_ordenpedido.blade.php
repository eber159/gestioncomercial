@section('title-page')
	ErpWeb | Pedidos / Bancos
@stop

@extends('intranet.plantilla_rpt')

@section('titulo-form')
	Reporte Pedidos <small>Panel de Control</small>
@stop
			...
			function InicializarTabla() {
				...
				var Table = $('#tblDatos').dataTable({
					...
					"aoColumns": [{
							...
							"sWidth": "5%", "mDataProp": "TipoPago"
						},{
							"sWidth": "5%", "mDataProp": "NumeroDocumento"
						},{
							"sWidth": "10%", "mDataProp": "Ventas"
						},{
							"sWidth": "15%", "mDataProp": "Direccion"
						},{
