@section('title-page')
	ErpWeb | Reporte Productos
@stop

@extends('intranet.plantilla_rpt')

@section('titulo-form')
	Reporte Productos <small>Panel de Control</small>
@stop

@section('subtitulo-form')
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-dashboard"></i> Reporte de Productos </a></li>
				...
				<div class="box box-primary">
					<div class="box-header with-border">
					  	<div>
					  		<div class="col-md-12">
					  			<div class="col-md-12">
					  				<button type="button" id="btnBuscarMovimientos" name="btnBuscarMovimientos" class="btn btn-success btn-sm"><i class="fa fa-refresh"></i> Listar </button>
					  			</div>
					  		</div>
					  		</br>
					  	</div>
			...
			function InicializarTabla() {
				...
				var Table = $('#tblDatos').dataTable({
					...
					"aoColumns": [{
							...
							"sWidth": "20%", "mDataProp": "Descripcion"
						}, {
							"sWidth": "10%", "mDataProp": "Marca"
						}, {
							"sWidth": "10%", "mDataProp": "Modelo"
						}, {
							"sWidth": "10%", "mDataProp": "Tamanio"
						},{
							"sWidth": "10%", "mDataProp": "Color"
						}],
					"order": [[ 3, "asc" ]],
				});
				*/
					...
					if (data !== null && typeof data === 'object') {
						$.each(data.lista, function (key, val) {
							var obj = {
									"Codigo": val["codigo"]
									,"Nombre": val["nombre"]
									,"Descripcion": val["descripcionguia"]
									,"Marca": val["marca"]
									,"Modelo": val["modelo"]
									,"Tamanio": val["tamanio"]
									,"Color": val["color"]
