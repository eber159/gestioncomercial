@section('title-page')
	ErpWeb | Gestión Documentos (Compras)
@stop

@extends('plantilla_int')

@section('titulo-form')
	Gestión de Documentos Internos (Compras) <small>Panel de Control</small>
@stop

@section('subtitulo-form')
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-dashboard"></i> Documentos Internos (Compras)</a></li>
	...
	<script type="text/javascript">
		...
		function Listar() {
			...
			$.ajax({
				type: "POST",
				async: false,
				data: { "idtipodocumento":{{config('constants.tipodocumento.documentointerno')}},"idtipocompraventa":0 },
				url: url,
				dataType: "json",
				beforeSend: function (data) {
