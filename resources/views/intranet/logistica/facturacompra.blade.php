@section('title-page')
	ErpWeb | Gestión Facturas (Compras)
@stop

@extends('plantilla_int')

@section('titulo-form')
	Gestión de Facturas (Compras) <small>Panel de Control</small>
@stop

@section('subtitulo-form')
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-dashboard"></i> Facturas (Compras)</a></li>
	...
	<script type="text/javascript">
		...
		function Listar() {
			...
			$.ajax({
				type: "POST",
				async: false,
				data: { "idtipodocumento":{{config('constants.tipodocumento.factura')}}, "idtipocompraventa": 0 },
				url: url,
				dataType: "json",
				beforeSend: function (data) {
