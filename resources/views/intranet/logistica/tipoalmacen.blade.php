@section('title-page')
	ErpWeb | Gestión Tipo Almacenes
@stop

@extends('plantilla_int')

@section('titulo-form')
	Gestión de Tipo Almacenes <small>Panel de Control</small>
@stop

@section('subtitulo-form')
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-dashboard"></i> Tipo Almacenes</a></li>
						...
						<div class="box-body">
							<div class="col-md-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ingrese Tipo Almacen" style="width: 100%">
								</div>
							</div>
						</div>
					  <!-- /.box-body -->
	...
	<script type="text/javascript">
		$(function () {
			...
			$("#btnGuardar").on("click", function(event) {
				...
				var resp = Guardar(form,'tipoalmacen/Guardar');
				if(resp=="ok"){
						...
						$.each(data.lista, function (key, val) {
							var obj = {"Id": val["id"]
									...
									,"Acciones":"<center><div class='hidden-sm hidden-xs action-buttons'>"
													+"<a href='javascript:;' onclick='Editar(\"tipoalmacen/Leer\","+val["id"]+")' class='blue'>"
														+"<i class='ace-icon fa fa-pencil bigger-130'></i>"
													+"</a>&nbsp;"
													+"<a href='javascript:;' onclick='Eliminar(\"tipoalmacen/Eliminar\","+val["id"]+")' class='red'>"
