@section('title-page')
	ErpWeb | Gestión Boletas (Compras)
@stop

@extends('plantilla_int')

@section('titulo-form')
	Gestión de Boletas (Compras) <small>Panel de Control</small>
@stop

@section('subtitulo-form')
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-dashboard"></i> Boletas (Compras)</a></li>
...
@section('stripts_especific')
	...
	<script type="text/javascript">
		...
		function Listar() {
			var url = "../comercial/facturaventa/Listar";
			$.ajax({
				type: "POST",
				async: false,
				data: { "idtipodocumento":{{config('constants.tipodocumento.boleta')}},"idtipocompraventa": 0},
				url: url,
				dataType: "json",
				beforeSend: function (data) {
