@section('title-page')
	ErpWeb | Gestión Nosotros
@stop

@extends('intranet.plantilla_int')

@section('titulo-form')
	Gestión de Nosotros <small>Panel de Control</small>
@stop

@section('subtitulo-form')
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-dashboard"></i> Nosotros</a></li>
						...
						<div class="box-body">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="titulo" name="titulo" placeholder="Ingrese Título" style="width: 100%" required>
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group">
	...
	<script type="text/javascript">
		$(function () {
			...
			$("#btnGuardar").on("click", function(event) {
				...
				var resp = Guardar(form,'nosotros/Guardar');
				if(resp=="ok"){
					...
					if (data !== null && typeof data === 'object') {
						$.each(data.lista, function (key, val) {
							var obj = {"Id": val["id"]
									...
									,"Acciones":"<center>"
													+"<a href='javascript:;' class='btn btn-primary btn-xs' onclick='Editar(\"nosotros/Leer\","+val["id"]+")' class='blue'>"
														+"<i class='ace-icon fa fa-pencil bigger-130'></i>"
													+"</a>&nbsp;"
													+"<a href='javascript:;' class='btn btn-danger btn-xs' onclick='Eliminar(\"nosotros/Eliminar\","+val["id"]+")' class='red'>"
        ...
        $("#frmRegistro").submit(function(e) {
            var url = "nosotros/Guardar"; // the script where you handle the form input.  
