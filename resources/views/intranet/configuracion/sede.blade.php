@section('title-page')
	ErpWeb | Gestión Sedes
@stop

@extends('plantilla_int')

@section('titulo-form')
	Gestión de Sedes <small>Panel de Control</small>
@stop

@section('subtitulo-form')
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-dashboard"></i> Sedes </a></li>
						...
						<div class="box-body">
							<div class="col-md-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ingrese Sede" style="width: 100%">
								</div>
							</div>
						</div>
					  <!-- /.box-body -->
	...
	<script type="text/javascript">
		$(function () {
			...
			$("#btnGuardar").on("click", function(event) {
				...
				var resp = Guardar(form,'sede/Guardar');
				if(resp=="ok"){
						...
						$.each(data.lista, function (key, val) {
							var obj = {"Id": val["id"]
									...
									,"Acciones":"<center><div class='hidden-sm hidden-xs action-buttons'>"
													+"<a href='javascript:;' onclick='Editar(\"sede/Leer\","+val["id"]+")' class='blue'>"
														+"<i class='ace-icon fa fa-pencil bigger-130'></i>"
													+"</a>&nbsp;"
													+"<a href='javascript:;' onclick='Eliminar(\"sede/Eliminar\","+val["id"]+")' class='red'>"
