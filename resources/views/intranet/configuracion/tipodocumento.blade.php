...
@section('titulo-form')
	Gestión de Tipos de documento <small>Panel de Control</small>
@stop

@section('subtitulo-form')
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-dashboard"></i> Tipo Documentos</a></li>
	...
	<script type="text/javascript">
		$(function () {
			...
			$("#btnGuardar").on("click", function(event) {
				...
				var resp = Guardar(form,'tipodocumento/Guardar');
				if(resp=="ok"){
						...
						$.each(data.lista, function (key, val) {
							var obj = {"Id": val["id"]
									...
									,"Acciones":"<center><div class='hidden-sm hidden-xs action-buttons'>"
													+"<a href='javascript:;' onclick='Editar(\"tipodocumento/Leer\","+val["id"]+")' class='blue'>"
														+"<i class='ace-icon fa fa-pencil bigger-130'></i>"
													+"</a>&nbsp;"
													+"<a href='javascript:;' onclick='Eliminar(\"tipodocumento/Eliminar\","+val["id"]+")' class='red'>"
