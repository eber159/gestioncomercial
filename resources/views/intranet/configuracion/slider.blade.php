@section('title-page')
	ErpWeb | Gestión Slider
@stop

@extends('intranet.plantilla_int')

@section('titulo-form')
	Gestión de Slider <small>Panel de Control</small>
@stop
						...
						<div class="box-body">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="titulo" name="titulo" placeholder="Ingrese Título" style="width: 100%" >
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group">
	...
	<script type="text/javascript">
		$(function () {
			...
			$("#btnGuardar").on("click", function(event) {
				...
				var resp = Guardar(form,'slider/Guardar');
				if(resp=="ok"){
				...
				success: function (data) {
					...
					if (data !== null && typeof data === 'object') {
						$.each(data.lista, function (key, val) {
							var obj = {"Id": val["id"]
									,"Nombre": "<a href='#' class='btn btn-default btn-xs' onclick='VerImagen("+val["id"]+")' ><i class='fa fa-image'></i></a>"+val["titulo"]
									,"Descripcion": val["descripcion"]
									,"Acciones":"<center>"
													+"<a href='javascript:;' class='btn btn-primary btn-xs' onclick='Editar(\"slider/Leer\","+val["id"]+")' class='blue'>"
														+"<i class='ace-icon fa fa-pencil bigger-130'></i>"
													+"</a>&nbsp;"
													+"<a href='javascript:;' class='btn btn-danger btn-xs' onclick='Eliminar(\"slider/Eliminar\","+val["id"]+")' class='red'>"
        ...
        $("#frmRegistro").submit(function(e) {
            var url = "slider/Guardar"; // the script where you handle the form input.  
