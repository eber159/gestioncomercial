@section('title-page')
	ErpWeb | Gestión Categorías
@stop

@extends('intranet.plantilla_int')

@section('titulo-form')
	Gestión de Categorías <small>Panel de Control</small>
@stop
						...
						<div class="box-body">
							...
							<div class="col-md-2">
								<div class="form-group">
									...
									<input type="number" class="form-control" id="orden" name="orden" placeholder="0" style="width: 100%" required>
								</div>
							</div>
							...
							<div class="col-md-12">
								<div class="form-group">
									<label for="">Imagen Slider</label>
									<input type="file" id="imagenslider" name="imagenslider" onchange="readURL2(this);">
									<br/>
									<img id="imagensel2" src="#" alt="your image" />
								</div>
							</div>
	...
	<script type="text/javascript">
		$(function () {
			...
			$("#btnGuardar").on("click", function(event) {
				...
				var resp = Guardar(form,'linea/Guardar');
				if(resp=="ok"){
					...
					if (data !== null && typeof data === 'object') {
						$.each(data.lista, function (key, val) {
							var obj = {"Id": val["id"]
									...
									,"Acciones":"<center>"
													+"<a href='javascript:;' class='btn btn-primary btn-xs' onclick='Editar(\"linea/Leer\","+val["id"]+")' class='blue'>"
														+"<i class='ace-icon fa fa-pencil bigger-130'></i>"
													+"</a>&nbsp;"
													+"<a href='javascript:;' class='btn btn-danger btn-xs' onclick='Eliminar(\"linea/Eliminar\","+val["id"]+")' class='red'>"
        ...
        $("#frmRegistro").submit(function(e) {
            var url = "linea/Guardar"; // the script where you handle the form input.  
