@section('title-page')
	ErpWeb | Gestión Enlaces
@stop

@extends('intranet.plantilla_int')

@section('titulo-form')
	Gestión de Enlaces <small>Panel de Control</small>
@stop
			...
			<div class="col-md-12">
				<div class="box box-primary">
					<form role="form" id="frmRegistro" enctype="multipart/form-data">
						...
						<input type="hidden" class="form-control" id="idtipo" name="idtipo" placeholder="Ingrese tipo" value="1" style="width: 100%">
						<div class="box-body">
